...
# session receives none of it. The README records the measurement and the client
# version it was taken on. That gap is silent for exactly the rules that most
